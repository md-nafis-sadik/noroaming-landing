  ...
  const goals: GoalItem[] = [
    {
      ...
      description: "Select a country or global plan that fits your needs.",
      icon: <ComputerIcon />,
    ...
    },
    {
      ...
      description: "Scan a QR code or use our app for instant activation.",
      icon: <ConnectionIcon />,
        ...
        >
          {goals.map((goal, index) => (
            ...
            >
              ...
              <p
                className={`text-lg md:text-xl lg:text-[34px] ${goal.titleclass} text-left relative z-10`}
              >
                {goal.title}
              </p>
              <p
                className={`text-xs md:text-sm mt-4 ${goal.descriptionclass} lg:text-base text-left relative z-10`}
              >
                {goal.description}
              </p>
            </div>
