...
const Navbar: FC = () => {
  ...
  return (
    ...
    >
      <div className="containerX flex flex-row items-center justify-between gap-4 py-8 px-24">
        ...
        <div className="flex flex-row items-center gap-2 md:gap-3">
          ...
          {/* GET IN TOUCH */}
          <Button className="hidden md:flex bg-secondary-600 hover:bg-sky-600 flex_center gap-2 group ps-3 md:px-5 font-semibold text-white text-sm">
